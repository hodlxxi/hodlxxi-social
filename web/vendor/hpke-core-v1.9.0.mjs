// Generated by scripts/build-v128e-hpke-browser.mjs from @hpke/core 1.9.0; MIT notice: ./hpke-js-MIT-LICENSE.txt; do not edit.
...
async function loadSubtleCrypto() {
  ...
  try {
    const { webcrypto: webcrypto2 } = await Promise.resolve().then(() => (init_crypto(), crypto_exports));
